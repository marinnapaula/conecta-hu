...
# =====================================================================
# 3. CARREGAMENTO DOS DADOS E CACHE INTEGRADO
# =====================================================================
...
with tab_fila:
    if not df_pend.empty:
        ...
        # =================================================================
        # INDICADORES EXECUTIVOS DA FILA
        # =================================================================
        total_f = len(df_p)
        ...
        # =================================================================
        # FICHA TÉCNICA DRILL-DOWN + ATIVIDADES
        # =================================================================
                    ...
                    if not df_atividades.empty:
                        ...
                        if col_os_at:
                            ...
                            if not df_historico_os.empty:
                                ...
                                st.info("Esta O.S. está aguardando o primeiro apontamento técnico.")
                        else:
                            st.warning("Coluna 'O.S.' não localizada nos arquivos de Atividades.")
                    else:
                        st.info("Nenhum log disponível na pasta '03.Atividades'.")
        else:
            st.warning("Ajuste os critérios de busca para carregar as fichas técnicas.")
    else:
